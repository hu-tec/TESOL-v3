                ...
                {[
                  ...
                  <div key={i} className="bg-white p-4 border border-gray-100 hover:shadow-sm transition-shadow flex items-center gap-4">
                    <div className="w-12 h-12 bg-white flex-shrink-0 flex items-center justify-center border border-gray-100">
                      <ImageWithFallback src={`${import.meta.env.BASE_URL}img/logo/center_${i+1}.png`} alt={item.title} className="max-w-[90%] max-h-[90%] object-contain" />
                    </div>
                    <div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="bg-white p-4 border border-gray-100 hover:shadow-sm transition-shadow flex items-center gap-4">
                    <div className="w-12 h-12 bg-white flex-shrink-0 flex items-center justify-center border border-gray-100">
                      <ImageWithFallback src={`${import.meta.env.BASE_URL}img/logo/partner_${i+1}.${i === 7 ? 'jpg' : 'png'}`} alt={item.name} className="max-w-[90%] max-h-[90%] object-contain" />
                    </div>
                    <div>
                ...
                {[
                  ...
                  <div key={i} className="bg-white p-3 border border-gray-100 flex items-center justify-between hover:shadow-sm transition-shadow group">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 bg-white flex-shrink-0 flex items-center justify-center border border-gray-100">
                        <ImageWithFallback src={`${import.meta.env.BASE_URL}img/logo/global_${i+1}.png`} alt={item.name} className="max-w-[90%] max-h-[90%] object-contain" />
                      </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="bg-white p-4 border border-gray-100 hover:shadow-sm transition-shadow flex items-center gap-4">
                    <div className="w-12 h-12 bg-white flex-shrink-0 flex items-center justify-center border border-gray-100">
                      <ImageWithFallback src={`${import.meta.env.BASE_URL}img/logo/overseas_${i+1}.png`} alt={item.title} className="max-w-[90%] max-h-[90%] object-contain" />
                    </div>
                    <div>
                      <h4 className="text-[14px] text-[#1a1a2e] font-bold">{item.title}</h4>
                      <p className="text-gray-500 text-[11px] mt-1">{item.desc}</p>
